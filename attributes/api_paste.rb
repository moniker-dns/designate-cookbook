...
default[:designate]['api_paste']['composite:osapi_dns_v1']['use'] = 'call:designate.api.auth:pipeline_factory'
default[:designate]['api_paste']['composite:osapi_dns_v1']['noauth'] = 'noauthcontext osapi_dns_app_v1'
default[:designate]['api_paste']['composite:osapi_dns_v1']['keystone'] = 'authtoken keystonecontext osapi_dns_app_v1'
default[:designate]['api_paste']['app:osapi_dns_app_v1']['paste.app_factory'] = 'designate.api.v1:factory'
default[:designate]['api_paste']['filter:faultwrapper_v1']['paste.filter_factory'] = 'designate.api.v1:FaultWrapperMiddleware.factory'
default[:designate]['api_paste']['filter:noauthcontext']['paste.filter_factory'] = 'designate.api.auth:NoAuthContextMiddleware.factory'
default[:designate]['api_paste']['filter:keystonecontext']['paste.filter_factory'] = 'designate.api.auth:KeystoneContextMiddleware.factory'
