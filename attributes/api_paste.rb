...
default[:designate]['api_paste']['composite:osapi_dns_v1']['noauth'] = 'noauthcontext maintenance faultwrapper_v1 osapi_dns_app_v1'
default[:designate]['api_paste']['composite:osapi_dns_v1']['keystone'] = 'authtoken keystonecontext maintenance faultwrapper_v1 osapi_dns_app_v1'
